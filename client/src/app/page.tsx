...
function Page() {
  ...
  return (
    <div className="flex relative flex-col font-normal w-full h-full">
      ...
      <div className="bg-cover w-full h-screen lg:bg-bottom bg-top bg-[url('/back.jpg')] px-4 lg:px-40 py-4 lg:py-12 flex flex-col items-center justify-between pb-24">
